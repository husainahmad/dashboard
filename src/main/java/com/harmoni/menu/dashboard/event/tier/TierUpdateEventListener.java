...
/**
 * Called when the user clicks Update on the tier form: validates the binder,
 * posts the updated tier and broadcasts the result.
 */
...
public class TierUpdateEventListener implements ComponentEventListener<ClickEvent<Button>>,
    ...
    /**
     * Validates the tier form and, if valid, posts the updated tier.
     *
    ...
    public void onComponentEvent(ClickEvent<Button> buttonClickEvent) {
        ...
        restClientOrganizationService.updateTier(tierDto)
                .doOnError(error -> new BrandHandler(this.tierForm.getUi(),
                        Messages.get(Messages.Keys.NOTIFICATION_TIER_UPDATE_ERROR, error.getMessage())))
